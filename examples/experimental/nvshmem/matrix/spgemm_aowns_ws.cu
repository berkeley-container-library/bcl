...
int main(int argc, char** argv) {
  ...
  using queue_type = BCL::ChecksumQueue<BCL::cuda::CudaSparse_ptr<T, index_type>, BCL::djb2_hash<BCL::cuda::CudaSparse_ptr<T, index_type>>>;
  ...
  BCL::cuda::gemm_aowns_ws(a, b, c, queues, ws_grid);
